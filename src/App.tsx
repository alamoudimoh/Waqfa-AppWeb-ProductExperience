...
import { getLocalDayPhase, themeForPhase } from './dayPhase'
...
function Opening({ theme, phase }: { theme: DayTheme; phase: ReturnType<typeof getLocalDayPhase> }) {
  return <div className="opening phase" data-phase="dawn" data-journey-phase={phase} data-theme={theme}>
    <section className="hero shell" aria-labelledby="hero-title">
      <div className="hero-topline"><Chapter number="٠١">رفيق الذِّكر والوِرد</Chapter><span>من وقتك الآن، إلى آخر اليوم</span></div>
...
export default function App() {
  ...
  return <DayEnvironment startPhase={localPhase}>
    ...
    <main id="main" tabIndex={-1}><Opening theme={topTheme} phase={localPhase} /><Morning /><Continuation /><Continuity /><Promise /><Closing /></main>
